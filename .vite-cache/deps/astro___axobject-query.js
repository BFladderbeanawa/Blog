  ...
  "node_modules/axobject-query/lib/AXObjectElementMap.js"(exports) {
    ...
    var AXObjectElementMap = {
      ...
      forEach: function forEach(fn) {
        var thisArg = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null
        for (
          var _i = 0, _AXObjectElements = AXObjectElements;
          _i < _AXObjectElements.length;
          _i++
        ) {
    ...
    var _default = (0, _iterationDecorator.default)(
      AXObjectElementMap,
  ...
  "node_modules/axobject-query/lib/AXObjectRoleMap.js"(exports) {
    ...
    var AXObjectRoleMap = {
      ...
      forEach: function forEach(fn) {
        var thisArg = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null
        for (
          var _i = 0, _AXObjectRoleElements = AXObjectRoleElements;
          _i < _AXObjectRoleElements.length;
          _i++
        ) {
  ...
  "node_modules/axobject-query/lib/elementAXObjectMap.js"(exports) {
    ...
    var elementAXObjectMap = {
      ...
      forEach: function forEach(fn) {
        var thisArg = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null
        for (
          var _i = 0, _elementAXObjects = elementAXObjects;
          _i < _elementAXObjects.length;
          _i++
        ) {
      ...
      get: function get(key) {
        var item = elementAXObjects.find(function (tuple) {
          return (
            ...
            deepAxObjectModelRelationshipConceptAttributeCheck(key.attributes, tuple[0].attributes)
          )
        })
        return item && item[1]
      },
...
var require_lib = __commonJS({
  "node_modules/axobject-query/lib/index.js"(exports) {
    ...
    exports.elementAXObjects =
      exports.AXObjects =
      exports.AXObjectRoles =
      exports.AXObjectElements =
        void 0
