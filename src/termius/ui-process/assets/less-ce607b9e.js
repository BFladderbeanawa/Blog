const e="Opposite of more",n="less",t=[{template:["filepaths"],isVariadic:!0}],s=[{description:'This option displays a summary of the commands accepted by less (the same as the h command).  (Depending on how your shell interprets the question mark, it may be necessary to quote the question mark, thus: "-?"',name:["-?","--help"]},{description:`By default, forward searches start at the top of the displayed
...
prior to 441`,name:["-A","--SEARCH-SKIP-SCREEN"]},{description:`Specifies the amount of buffer space less will use for each
file, in units of kilobytes (1024 bytes).  By default 64 KB of
buffer space is used for each file (unless the file is a pipe;
see the -B option).  The -b option specifies instead that n
kilobytes of buffer space should be used for each file.  If n is
-1, buffer space is unlimited; that is, the entire file can be
read into memory`,name:["-b","--buffers"],args:[{name:"n"}]},{description:`By default, when data is read from a pipe, buffers are allocated
...
earlier data is lost`,name:["-B","--auto-buffers"]},{description:`Causes full screen repaints to be painted from the top line
down.  By default, full screen repaints are done by scrolling
from the bottom of the screen`,name:["-c","--clear-screen"]},{description:"Same as -c, for compatibility with older versions of less",name:["-C","--CLEAR-SCREEN"]},{description:`The -d option suppresses the error message normally displayed if
the terminal is dumb; that is, lacks some important capability,
such as the ability to clear the screen or scroll backward.  The
-d option does not otherwise change the behavior of less on a
dumb terminal`,name:["-d","--dumb"]},{description:`Changes the color of different parts of the displayed text.  x
...
https://docs.microsoft.com/en-us/windows/console/char-info-str)`,name:["-D","--color"],args:[{name:"xcolor"}]},{description:`Causes less to automatically exit the second time it reaches
end-of-file.  By default, the only way to exit less is via the
"q" command`,name:["-e","--quit-at-eof"]},{description:`Causes less to automatically exit the first time it reaches end-
of-file`,name:["-E","--QUIT-AT-EOF"]},{description:`Forces non-regular files to be opened.  (A non-regular file is a
...
set`,name:["-f","--force"]},{description:`Causes less to automatically exit if the entire file can be
displayed on the first screen`,name:["-F","--quit-if-one-screen"]},{description:`Normally, less will highlight ALL strings which match the last
...
search commands`,name:["-G","--HILITE-SEARCH"]},{description:`Specifies a maximum number of lines to scroll backward.  If it
is necessary to scroll backward more than n lines, the screen is
repainted in a forward direction instead.  (If the terminal does
not have the ability to scroll backward, -h0 is implied.)`,name:["-h","--max-back-scroll"],args:[{name:"n"}]},{description:`Causes searches to ignore case; that is, uppercase and lowercase
...
uppercase letters`,name:["-I","--IGNORE-CASE"]},{description:`Specifies a line on the screen where the "target" line is to be
...
screen respectively`,name:["-j","--jump-target"],args:[{name:"n"}]},{description:`Displays a status column at the left edge of the screen.  The
status column shows the lines that matched the current search,
and any lines that are marked (via the m or M command)`,name:["-J","--status-column"]},{description:`Causes less to open and interpret the named file as a lesskey(1)
...
as a lesskey file`,name:["-k","--lesskey-file"],args:[{name:"filename",template:["filepaths"]}]},{description:`Causes less to exit immediately (with status 2) when an
...
command`,name:["-K","--quit-on-intr"]},{description:`Ignore the LESSOPEN environment variable (see the INPUT
PREPROCESSOR section below).  This option can be set from within
less, but it will apply only to files opened subsequently, not
to the file which is currently open`,name:["-L","--no-lessopen"]},{description:`Causes less to prompt verbosely (like more), with the percent
into the file.  By default, less prompts with a colon`,name:["-m","--long-prompt"]},{description:"Causes less to prompt even more verbosely than more",name:["-M","--LONG-PROMPT"]},{description:`Suppresses line numbers.  The default (to use line numbers) may
...
line in the display`,name:["-N","--LINE-NUMBERS"]},{description:`Causes less to copy its input to the named file as it is being
...
command is equivalent to specifying -o from within less`,name:["-O","--LOG-FILE"],args:[{name:"filename",template:["filepaths"]}]},{description:`The -p option on the command line is equivalent to specifying
+/pattern; that is, it tells less to start at the first
occurrence of pattern in the file`,name:["-p","--pattern"],args:[{name:"pattern"}]},{description:`Provides a way to tailor the three prompt styles to your own
...
escape sequences.  See the section on PROMPTS for more details`,name:["-P","--prompt"],args:[{name:"prompt"}]},{description:`Causes moderately "quiet" operation: the terminal bell is not
...
cases where the terminal bell would have been rung`,name:["-Q","--QUIET","--SILENT"]},{description:`Causes "raw" control characters to be displayed.  The default is
...
list of characters which can appear`,name:["-R","--RAW-CONTROL-CHARS"]},{description:`Causes consecutive blank lines to be squeezed into a single
blank line.  This is useful when viewing nroff output`,name:["-s","--squeeze-blank-lines"]},{description:`Causes lines longer than the screen width to be chopped
...
that is, display the remainder on the next line`,name:["-S","--chop-long-lines"]},{description:`The -t option, followed immediately by a TAG, will edit the file
...
is equivalent to specifying -t from within less`,name:["-t","--tag"],args:[{name:"tag"}]},{description:'Specifies a tags file to be used instead of "tags"',name:["-T","--tag-file"],args:[{name:"tagsfile"}]},{description:`Causes backspaces and carriage returns to be treated as
...
-U is in effect`,name:["-U","--UNDERLINE-SPECIAL"]},{description:"Displays the version number of less",name:["-V","--version"]},{description:`Temporarily highlights the first "new" line after a forward
...
forward movement command larger than one line`,name:["-W","--HILITE-UNREAD"]},{description:`Sets tab stops.  If only one n is specified, tab stops are set
...
default for n is 8`,name:["-x","--tabs="],args:[{name:"n,..."}]},{description:`Disables sending the termcap initialization and deinitialization
strings to the terminal.  This is sometimes desirable if the
deinitialization string does something unnecessary, like
clearing the screen`,name:["-X","--no-init"]},{description:`Specifies a maximum number of lines to scroll forward.  If it is
necessary to scroll forward more than n lines, the screen is
repainted instead.  The -c or -C option may be used to repaint
from the top of the screen if desired.  By default, any forward
movement causes scrolling`,name:["-y","--max-forw-scroll"],args:[{name:"n"}]},{description:`Changes the default scrolling window size to n lines.  The
...
lines, the scrolling window automatically changes to 36 lines`,name:["-z","--window"],args:[{name:"n"}]},{description:`Changes the filename quoting character.  This may be necessary
...
quote)`,name:"--quotes"},{description:`Normally lines after end of file are displayed as a single tilde
(~).  This option causes lines after end of file to be displayed
as blank lines`,name:["-~","--tilde"]},{description:`Specifies the default number of positions to scroll horizontally
...
width`,name:["-#","--shift"]},{description:`Normally, if the input file is renamed while an F command is
...
renamed) file), less will display the contents of that new file`,name:"--follow-name"},{description:`Subsequent search commands will be "incremental"; that is, less
will advance to the next line containing the search pattern as
each character of the pattern is typed in`,name:"--incsearch"},{description:`Sets the minimum width of the line number field when the -N
option is in effect.  The default is 7 characters`,name:"--line-num-width"},{description:`Enables mouse input: scrolling the mouse wheel down moves
...
movement is reversed`,name:"--MOUSE"},{description:`Disables sending the keypad initialization and deinitialization
strings to the terminal.  This is sometimes useful if the keypad
strings make the numeric keypad behave in an undesirable manner`,name:"--no-keypad"},{description:`This option changes the behavior so that if a search string or
...
multiple times`,name:"--no-histdups"},{description:`This option changes the character used to mark truncated lines.
It may begin with a two-character attribute indicator like
LESSBINFMT does.  If there is no attribute indicator, standout
is used.  If set to "-", truncated lines are not marked`,name:"--rscroll"},{description:`Save marks in the history file, so marks are retained across
different invocations of less`,name:"--save-marks"},{description:`Sets the width of the status column when the -J option is in
effect.  The default is 2 characters`,name:"--status-col-width"},{description:`This option changes the interpretations of options which follow
this one.  After the --use-backslash option, any backslash in an
option string is removed and the following character is taken
literally.  This allows a dollar sign to be included in option
strings`,name:"--use-backslash"},{description:`Enables the colored text in various places.  The -D option can
...
standards/standards/ecma-48)`,name:"--use-color"},{description:"Set the number of lines to scroll when the mouse wheel is rolled",name:"--wheel-lines",args:[{name:"n"}]}],i={description:e,name:n,args:t,options:s};export{t as args,i as default,e as description,n as name,s as options};
//# sourceMappingURL=less-ce607b9e.js.map
